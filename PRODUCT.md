...
## Product Purpose
Explain how ZCode, DeepSeek Harness, OpenAI Codex, and Google AX work through guided, interactive architecture diagrams backed by source code.

## Positioning
Students can move from a system overview to individual components, compare implementation trade-offs, and follow every factual claim to a pinned source revision. AX is a distributed orchestration layer around agent processes.
...
## Evidence on Hand
Primary-source reports are recorded under `research/`. Exact upstream revisions are pinned in `research/upstreams.json`. No controlled comparative performance evidence is available.

## Product Principles
- Source evidence accompanies factual claims.
- Category boundaries remain visible.
- Diagrams teach responsibility and data flow.
- Permission and containment are separate concepts.
- Incomplete public history stays explicitly incomplete.
